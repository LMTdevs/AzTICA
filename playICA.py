...
mask380,idx380,l380=makeWmask(hitm,380,apix,l_init=0.19)
mask270,idx270,l270=makeWmask(hitm,270,apix,l_init=0.42)
m0s -= np.median(m0s[mask270])
m0_counts=countBrightSources(m0s*m0w,beams_excluded,beam_FWHM,mask270,printflag=True,SNtol=4)

cm=ContourMap(hitmap=hitm,xytitle=(0.5,0.96),plottodir=plottodir,filetype='pdf',
    pixsize=3,xlim=(-585,585),ylim=(-695,695),rotangle=20,xyoffset=(-7,1),dpi='figure',
...
redundant_dir=datadir+'/redundant/'
...
plotSeq(nm,A.T[3],
        ...
        clearcanv=False,plottodir=plottodir,saveflag=saveflag,filetype='pdf')
